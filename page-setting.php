...
if (!isset($_SESSION["userid"])) {
    ...
    $user_obj = new User();
    $userCurrent = $user_obj->getUser($_SESSION["userid"]); // Return Array (userCurrent = result[0])
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="grid lg:grid-cols-3 mt-12 gap-8">
                    ...
                    <div class="bg-white rounded-md lg:shadow-md shadow col-span-2 lg:mx-16">
                        ...
                        <div class="bg-gray-10 p-6 pt-0 flex justify-end space-x-3">
                            <button class="p-2 px-4 rounded bg-gray-50 text-red-500" onclick='window.history.back()'> Cancel </button>
                    ...
                    <div>
                        ...
                        <p> Adjusting your settings accordingly helps ensure that you maintain control over your information</p>
                    </div>
                    <div class="bg-white rounded-md lg:shadow-lg shadow col-span-2 lg:p-6 p-4 lg:mx-16">
                        ...
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <?php
                                $status = $user_obj->getStatusPrivacy($_SESSION["userid"]);
                                ?>
                                <div class="switches-list -mt-8 is-large">
                                    <div class="switch-container">
                                        <label class="switch"><input type="checkbox" <?php if ($status[0]["privacy"] == "public") echo "checked value='on'";
                                                                                        else echo "value='off'" ?> class="checkbox-privacy"><span class="switch-button"></span> </label>
