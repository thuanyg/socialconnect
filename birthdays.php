            ...
            <div class="header_wrap">
                <div class="header_inner mcontainer">
                    ...
                    <div class="header_search"><i class="uil-search-alt"></i>
                        <input value="" name="txtSearch" type="text" class="form-control"
                                ...
                                <div class="dropdown_scrollbar" data-simplebar>
                                    <div class="drop_headline">
                                        ...
                                        <div class="btn_action">
                                            ...
                                            <a href="#" class="btn-read-all-notification" data-tippy-placement="left"
                                ...
                                <div class="dropdown_scrollbar" data-simplebar>
                                    <div class="drop_headline">
                                        ...
                                        <div class="btn_action">
                                            ...
                                            <a href="#" class="btn-read-all-message" data-tippy-placement="left"
                                                title="Mark as read all">
                                                <ion-icon name="checkbox-outline"></ion-icon>
                                            </a>
                                        </div>
                            ...
                            <div uk-drop="mode: click;offset:5" class="header_dropdown profile_dropdown">
                                ...
                                <a href="timeline.php" class="user">
                                    ...
                                    <div class="user_name">
                                        ...
                                        <span> @
                                            <?php echo $userCurrent["url_address"]; ?>
                                        </span>
                                    </div>
                                </a>
                                <hr>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar_inner" data-simplebar>
                ...
                <ul>
                    ...
                    <li id="more-veiw" class="active" hidden><a href="birthdays.html">
                                                    ...
                                                    <div class="flex-1">
                                                        <div class="flex items-center justify-between mb-3">
                                                            ...
                                                            <div class="font-medium text-sm text-gray-400">
                                                                <?php echo $timer->calculateAge($about["birthday"]) ?> years old
                                                            </div>
                                                        </div>
                                                        <div class="relative">
